...
export default function BannerHighlights() {
	return (
		<div className='h-24 my-4 grid xs:grid-cols-2 md:grid-cols-3 items-center w-full text-lg max-w-2xl md:max-w-7xl mx-auto md:my-8 border-y border-gray-200 '>
